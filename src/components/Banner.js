    ...
    <div className='flex flex-col lg:flex-row'>
      <div className='lg:ml-8 xl:ml-[135px] flex flex-col items-center lg:items-start text-center lg:text-left justify-center flex-1 px-4'>
        ...
        <p className='max-w-[480px] mb-8'>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam corporis assumenda accusantium eligendi tempora, mollitia facilis minima nemo magni sapiente cum totam harum aspernatur provident iure odio sit ratione illum.
        </p>
      </div>
      {/* Imange */}
